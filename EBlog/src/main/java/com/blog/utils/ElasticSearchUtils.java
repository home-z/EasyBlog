...
public class ElasticSearchUtils {
	...
	static {
		try {
			...
			InputStream in = ElasticSearchUtils.class.getResourceAsStream("/elasticsearch.properties");
			props.load(in);// 加载文件
	 ...
	 * @throws Exception
	 */
	public static XContentBuilder createMapJson(Map<String, String> mapParam) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static XContentBuilder createEntityJson(Object entity, String... methodNameParm) throws Exception {
		...
		try {
			for (String methodName : methodNameParm) {
				...
				String fieldName = toLowerCaseFirstOne(methodName.replace("get", ""));// 去掉“get”，并将首字母小写
	...
	public static boolean addDoc(String type, String docId, Map<String, String> mapParam) {
		return addMapDocToIndex(type, docId, mapParam);
	}
	...
	public static boolean addDoc(String type, Map<String, String> mapParam) {
		return addMapDocToIndex(type, null, mapParam);
	}
	 ...
	 * @return
	 */
	private static boolean addMapDocToIndex(String type, String docId, Map<String, String> mapParam) {
	...
	public static boolean addDoc(String type, Object entity, String... methodNameParm) {
		return addEntityDoc(type, null, entity, methodNameParm);
	}
	...
	public static boolean addDoc(String type, String docId, Object entity, String... methodNameParm) {
		return addEntityDoc(type, docId, entity, methodNameParm);
	}
	 ...
	 * @return
	 */
	private static boolean addEntityDoc(String type, String docId, Object entity, String... methodNameParm) {
		boolean result = false;
	 ...
	 * @return
	 */
	public static Map<String, Object> multiOrSearchDocHigh(String type, Map<String, String> shouldMap) {
		TransportClient client = getClient();
